API_MESSAGE = {
    ...
    CITY_ALREADY_ADDED: "City Already exits",
    CITY_ADDED : "City Added successfully",
    ACCOUNT_ALREADY_EXIT : "Account already exists please login",
    VERIFY_YOUR_LINK : "Please verify your email",
    EMAIL_VERIFYED : "Email Verifyed successfully",
    ACCOUNT_VERIFIED_LINK_EMAIL : "Verification link is sent on your email",
    RATING_SUCCESSFULLY : "Thanku for your valuable feedback",
    NOTIFICATION_CLEAR : "Notification clear Successfully",
    COUPON_ALREADY_RATED : "Coupon already rated by you",
    STORE_ALREADY_RATED : "Store already rated by you",
    DELETE_INTERASTED_COUPON : "Delete interested coupon successfully",
    DELETE_NOT_INTERASTED_COUPON : "Delete not interested coupon successfully",
    ACCESS_TOKEN_NOT_FOUND : "Access token not found.",
    ACCESS_TOKEN_NOT_MACHED : "Access token not matched.",
    ACTIVE_YOUR_ACOUNT : "Activate you account first by activation link from your email address.",
    DEACTIVE_YOUR_ACOUNT : "You are deactivated by admin.Please contact your admin",
...
var Messages = {
    ...
    PRICELESSTHANGREATERTHEN : "Please enter value less then Original",
...
var ADMIN_MSG = {
    ...
    HELLO : "Hello",
    COUPON_VIEW_USERS : "Kupons -> VIEW USER",
    DASHBOARD_BRADCOM : "Dashboard",
    COUPONS_BRADCOMS : "Coupons",
    LANGSWITCH : "en",
    REDEEMED_KUPONS : "Redeemed Kupons",
    FILL_INPUT_FIELD : "Please fill this field",
    CATEGORY_NOT_SUBSCRIBED : "This category is not subscribed",
    ...
    newHome: "Home",
    newFeature: "Feature",
    newSuccessStories: "Kupon Success Stories",
    newSuccessStoryContent1: "Since I started using Kupon I am able to bring clients during times with less movement , better for me and better for them.",
    newSuccessStoryContent2: "I am using Kupon to sell inventory at end of the day with discount each day so customers will always get fresh bread .",
    newSuccessStoryContent3: "I have used kupon to create attractive kupons so people near my shop  will come and get to know us. Very happy having this platform.",
    newSuccessStoryContent4: "My restaurant is not in main street , until I started using kupon I had to invest a lot in publicity to get people to know my location , now I can just create special offers and people use the map in the kupon to find my restaurant. Great solution!",
    newSuccessStoryWriter1: "Elena, Lima",
    newSuccessStoryWriter2: "Pedro and Ana , Amazonas",
    ...
    REGISTER_WEB_SITE : "Register",
    newBannerDescription: "Business owners , anywhere in Spanish , either with one store or multiple stores can now reach new customers and existing customers using the Kupon Peru",
    ...
    //updated
    PaymentButton: "Renew Subscription.",
    RemainingDays: "Remaining Days",
    SubscriptionAmount: "Monthly subscription amount",
    RefrencAmpunt: "Please deposit this amount with this reference Id",
    PaymentTab: "Online Payment",
    ManualPaymentTab: "Manual Payment",
    Membership: "Membership Details",
    MembershipType: "Membership Type",
    TotalDays: "Plan Days",
    SubscriptionDate: "Subscription Date",
    SubscriptionEndDate: "Subscription End Date",
    ActivationMessage: "Once amount deposited, your subscription will be activated automatically",
    EmailSignupExists: "Email already exist",
    SelectAll:"Select All",
    AllowFileType:"Only jpg,png,jpeg,gif file allowed",
    Province:"Province",
    WelcomeSubject:"Welcome On Kupon",
    StoreName : "Store name is requird",
    StoreManagerName : "Store manager name is requird",
    StoreEmailName:"Enter a valid Email",
    StoreEmail : "Email is requird",
    StorePassword : "Password is requird",
    StoreLocation : "Location is requird",
    Password: "Password",
    NO_LIMIT:"No Limit",
    Max_User:"Max Units",
    COUPON_RATING : "Coupon Rating",
